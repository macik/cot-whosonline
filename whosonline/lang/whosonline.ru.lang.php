...
$L['cfg_disable_guests'] = array('Отключить учет не зарегистрированных пользователей', '');
$L['cfg_maxusersperpage'] = array('Кол-во записей на страницу в таблице онлайн пользователей', 'установите 0 для вывода всех онлайн пользователей разом');
